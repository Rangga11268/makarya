    ...
    <div className="space-y-16 sm:space-y-20 pb-16">
      ...
      <section className="bg-dark-900 text-white pt-10 pb-14 sm:pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-b border-border">
        ...
        <div className="max-w-6xl mx-auto relative z-10 space-y-8">
          ...
          <div className="max-w-3xl space-y-4">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif tracking-tight leading-[1.1] text-white">
              {isUmkm 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Pilih kategori yang sesuai dengan program studi dan keahlian digital yang Anda kuasai."
          action={
            <Link to="/projects">
      ...
      {/* 3. HOW IT WORKS */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-surface-soft border border-border rounded-3xl p-6 sm:p-10">
          <SectionHeader
            centered
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-6">
            <HowItWorksStep
              stepNumber={1}
              iconName="account"
              title={isUmkm ? "Pasang Rincian Proyek" : "Daftar Akun Mahasiswa"}
              description={isUmkm 
                ? "Tentukan judul, kategori keahlian, maksimal budget wajar (hingga Rp 2 Juta), dan batas tenggat waktu pengerjaan." 
            ...
            <HowItWorksStep
              stepNumber={2}
              iconName="apply"
              title={isUmkm ? "Pilih Proposal Mahasiswa" : "Lamar & Ajukan Proposal"}
              description={isUmkm 
            ...
            <HowItWorksStep
              stepNumber={3}
              iconName="complete"
              title={isUmkm ? "Review Hasil & Lepas Dana" : "Serahkan Hasil & Terima Honor"}
              description={isUmkm 
