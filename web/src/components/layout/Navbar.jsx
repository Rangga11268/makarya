                    ...
                    <div className="absolute left-0 mt-3 w-[460px] bg-white rounded-3xl border border-slate-200 shadow-2xl p-4 z-50 animate-in fade-in zoom-in-95 duration-150">
                      <div className="flex items-center justify-between pb-2.5 mb-2.5 border-b border-slate-100">
                        ...
                        <Link
                          ...
                          className="text-[11px] font-bold text-slate-900 hover:text-slate-700 flex items-center gap-1"
                        >
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            {isAuthenticated ? (
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/login"
                  className="text-xs font-semibold text-slate-700 hover:text-slate-950 px-3 py-1.5 transition-colors select-none"
                >
                  Masuk
                </Link>
                ...
                {authNavLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.path}
                      to={link.path}
                      className={`flex items-center gap-2.5 px-3 py-2 text-xs rounded-xl font-semibold ${
                        active
