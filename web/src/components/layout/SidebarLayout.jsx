  ...
  const coreNavLinks = (() => {
    ...
    if (isUmkm) {
      return [
        ...
        { label: "Pesan & Chat", path: "/chat", icon: MessageSquare },
      ];
    }
    // MAHASISWA
    return [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
              ...
              {/* Direct Chat Inbox Shortcut */}
              <Link
                to="/chat"
                className={cn(
                  "p-2 rounded-xl border border-slate-200/80 text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors relative",
                  location.pathname.startsWith("/chat") &&
                    "bg-slate-100 text-slate-950 font-bold border-slate-300 shadow-2xs",
                )}
                title="Pesan & Percakapan"
                ...
                {dropdownOpen && (
                  <div className="hidden sm:block absolute right-0 mt-2 w-64 bg-white rounded-2xl border border-slate-200 shadow-xl py-2 z-50 animate-in fade-in zoom-in-95 duration-100 font-sans">
                    ...
                    <div className="px-4 py-2.5 border-b border-slate-100">
                      ...
                      <div className="inline-flex items-center gap-1 mt-2 px-2 py-0.5 rounded-md bg-slate-100 text-[10px] font-semibold text-slate-700">
                        {isUmkm ? (
          ...
          >
            ...
            <div className="flex items-center gap-3.5 pb-3 border-b border-slate-100">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="inline-flex items-center gap-1 mt-1 px-2 py-0.5 rounded-md bg-slate-100 text-[10px] font-semibold text-slate-700">
                  {isUmkm ? (
                    <Building2 className="w-3 h-3 text-amber-600" />
                  ) : (
                    <CheckCircle2 className="w-3 h-3 text-emerald-600" />
