      ...
      {toasts.map((toast) => (
        <div
          ...
          className={cn(
            ...
            toast.type === "success" &&
              "border-emerald-300 bg-emerald-50/95 text-emerald-950 shadow-emerald-900/10",
            toast.type === "error" &&
              "border-rose-300 bg-rose-50/95 text-rose-950 shadow-rose-900/10",
            toast.type === "warning" &&
              "border-amber-300 bg-amber-50/95 text-amber-950 shadow-amber-900/10",
            toast.type === "info" &&
              "border-brand-indigo/30 bg-surface/95 text-dark-900 shadow-brand-indigo/10",
          )}
        >
          {toast.type === "success" && (
